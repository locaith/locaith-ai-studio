  ...
  return (
    <>
      ...
      <div className={`${hasSearched ? 'w-full max-w-[1920px] mx-auto px-4 md:px-4' : 'w-full max-w-4xl mx-auto mt-[10vh] md:mt-[15vh] px-4 md:px-6'} flex flex-col transition-all duration-700 h-full relative z-10`}>
        ...
        {/* Search Header */}
        <div className={`${hasSearched ? 'py-2 md:py-4 border-b border-border sticky top-0 z-30 bg-background/95 backdrop-blur-md pt-[calc(0.5rem+env(safe-area-inset-top))]' : 'p-0 flex flex-col items-center'} transition-all duration-500`}>
