-- =====================================================
-- COMPLETE AUTH & DATABASE RESET SCRIPT
-- WARNING: THIS WILL DELETE ALL EXISTING DATA
-- =====================================================

-- 1. CLEANUP (Drop everything to ensure clean slate)
-- =====================================================
...
-- Table: user_activity
-- Stores user actions for analytics/history
...
-- Profiles
-- Public read access is useful for showing avatars/names in shared projects
...
-- 5. TRIGGERS & FUNCTIONS (CRITICAL FOR GOOGLE LOGIN)
-- =====================================================
...
BEGIN
  ...
  VALUES (
    NEW.id,
    NEW.email,
    -- Try to get name from metadata (Google provides full_name or name), fallback to email
    COALESCE(NEW.raw_user_meta_data->>'full_name', NEW.raw_user_meta_data->>'name', NEW.email),
    -- Try to get avatar from metadata, fallback to empty string
    COALESCE(NEW.raw_user_meta_data->>'avatar_url', '')
  )
  -- If profile already exists (e.g. re-login), update it
