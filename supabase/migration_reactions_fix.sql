...
-- 1. Create message_reactions table if it doesn't exist
...
-- View policy
drop policy if exists "Users can see reactions for messages they can see." on public.message_reactions;
